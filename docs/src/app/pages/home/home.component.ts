    ...
    <section class="py-24 px-6 relative overflow-hidden">
      ...
      <div class="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div class="inline-flex items-center gap-3 px-4 py-2 rounded mb-8 border-2 border-camo-olive" style="background: linear-gradient(135deg, rgba(74, 93, 35, 0.9) 0%, rgba(45, 64, 34, 0.9) 100%);">
          ...
          <span class="text-camo-sand font-bold uppercase tracking-wider text-sm">v0.3.0 — 303 APPLETS — 108KB / 54KB UPX — 100% TOYBOX COMPATIBLE</span>
        </div>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="https://github.com/quinnjr/armybox" target="_blank" class="btn btn-secondary px-8 py-3 text-base">
            🔗 GitHub
          </a>
        </div>
      </div>
        ...
        <div class="rounded-lg overflow-hidden border-2 border-camo-olive" style="box-shadow: 6px 6px 0 rgba(45, 64, 34, 0.4);">
          ...
          <div class="p-6 font-mono text-sm" style="background: linear-gradient(135deg, #2d2b1f 0%, #1a1910 100%);">
            ...
            <div class="text-camo-olive mt-4 text-xs">
              # 303 utilities deployed. 108KB mission-ready. 54KB with UPX.
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="card">
            ...
            <p class="text-sm text-army-700">
              All 238 Toybox commands plus 65 additional utilities.
          ...
          <div class="card">
            ...
            <p class="text-sm text-army-700">
              All 303 utilities in one tiny binary.
          ...
          <div class="card border-camo-olive">
            ...
            <ul class="space-y-3 text-sm">
              ...
              <li class="flex justify-between py-2 border-b border-camo-sand">
                ...
                <strong class="text-army-900">303 (100% Toybox + extras)</strong>
              </li>
          ...
          <table class="w-full text-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="py-3 px-4 text-center font-bold text-army-900">303</td>
